package com.fourbears.mall.component;

import com.fourbears.mall.bo.WebLog;
import com.fourbears.mall.util.JsonUtil;
import com.fourbears.mall.util.RequestUtil;
...
public class WebLogAspect {
    ...
    @Pointcut("execution(public * com.fourbears.mall.controller.*.*(..))")
    public void webLog() {
    }
